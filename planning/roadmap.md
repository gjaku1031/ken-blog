...
| P2-02B | 기본 블록 편집·수동 저장/출간 화면 | 완료: 정적 글쓰기·원문 보존·편집본 목록, main `814715c`·CI·Pages |
| P2-02C | 표 편집·안전한 접기 읽기 | main `01964c8`·CI·Pages 반영 |
| P2-02D | 접기 블록 편집·그룹 이동 | 완료: main `9dc415d`·CI·Pages, 한 단계 편집·중첩 원문 보존 |
| P2-03A | 이미지 연결·권한별 전달 API | main `5fd3e32`·CI·Pages 완료 |
| P2-03B | 이미지 입력·본문 표시 | 완료: main `ea3a948`·CI·Pages, 업로드/캡션/정렬/폭·권한별 이미지 읽기 |
| P2-04A | 코드 블록 구문 강조·언어 편집 | 완료: main `94d331d`·CI·Pages, 실제 Shiki·지연 로딩·원문 유지 |
| P2-04B | 수식 읽기·블록 편집 | 완료: main `d4d291d`·CI·Pages, KaTeX·통화 구분·원문 보존 |
| P2-04C | Mermaid 도식 읽기·블록 편집 | 완료: main `37206ca`·CI·Pages, 실제 도식·소스 전환·안전한 지연 렌더 |
| P2-05A | 번호·이름 주석 읽기 | 완료: main `2614569`·CI·Pages, 문서 전체 주석·말풍선·목록 이동 |
| P2-05B | 주석 삽입·에디터 전체 미리보기 | 완료: main `6dc3988`·CI·Pages, 커서 보존·문서 번호 일치 |
| P2-06A | 위키 링크 대상 조회 API | 완료: main `d5638dd`·CI·Pages, 제목·권한별 대상 상태 |
| P2-06B | 위키 링크 읽기 | 구현·격리 검증 완료: 안전한 문법·상태별 본문/주석 링크 |
| P2-06C | 관리자 위키 검색·선택기 | 후속: 제목 추천·커서 삽입·없는 글 작성 |
| P2-06D | 역링크 | 후속: 권한별 참조 글 |
| P2-06E | 목차 | 후속: 안정적 제목 앵커·scrollspy |
