...
- 현재 계획: [P0-04 — 정적 프론트 Pages 배포와 Spring 실행 이미지](issues/P0-04.md).
- 상태: P0-04 구조 수정 승인·구현 진행 중. Next 정적 Pages + VM Spring으로 전환. 아래 조건은 선행 P0-03 검증 이력이며 현재 배포 구조를 뜻하지 않음.
...
[P0-04 — 정적 프론트 Pages 배포와 Spring 실행 이미지](issues/P0-04.md). 계획 초안이며 별도 승인 전 구현 없음.
